    ...
    <section id="about" className="py-[80px] md:py-[120px] px-6 md:px-12 w-full max-w-7xl mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-[60%_40%] gap-16 md:gap-24 items-center">
        ...
        <div className="flex flex-col">
          ...
          <p 
            ref={p1Ref as any}
            className="text-[#f5f0eb] font-normal text-[20px] leading-[1.6] max-w-[520px] mb-8 transition-all duration-700 delay-200 opacity-0 translate-y-[30px] [.revealed_&]:opacity-100 [.revealed_&]:translate-y-0"
          >
          ...
          <p 
            ref={p2Ref as any}
            className="text-[#8a8580] font-light text-[15px] max-w-[520px] leading-relaxed transition-all duration-700 delay-400 opacity-0 translate-y-[30px] [.revealed_&]:opacity-100 [.revealed_&]:translate-y-0"
          >
        ...
        <div 
          ref={imgRef as any}
          className="relative w-full aspect-[3/4] overflow-hidden group transition-all duration-1000 opacity-0 [.revealed_&]:opacity-100"
        >
          <img 
            src={aboutPortrait} 
            alt="Thea Rivera at work" 
            className="w-full h-full object-cover transition-transform duration-[1.5s] ease-out scale-[1.1] [.revealed_&]:scale-100 group-hover:scale-[1.02]"
          />
        </div>
